...
public class ListDemo
{
    public static void main(String[] args)
    {
        ...
        */
        ...
        /*
            Enhanced for loops work with linked lists because they
                implement the list iterface
        */
        for(String n : staff)
        {
            System.out.print(n + " ");
        ...
        /*
            ...
            Cannot modify a linked list while there is an active iterator
        ...
        */
        ...
        /*
            ...
            The enahnced for loop automaticcaly creates an iterator!
            That's how it works!
        */
        for(String n : staff)
        {
